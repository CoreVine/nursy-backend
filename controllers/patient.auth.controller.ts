...
export default class PatientAuthController {
  ...
  static async register(req: Request, res: Response) {
    ...
    const emailTemplate = await emailService.sendTemplateEmail(user.email, CONFIG.APP_NAME, "account-verification", {
      name: user.username,
  ...
  static async sendVerificationToken(req: Request, res: Response) {
    ...
    await emailService.sendTemplateEmail(user.email, CONFIG.APP_NAME, "account-verification", {
      name: user.username,
      verificationCode: randomInt,
      companyName: CONFIG.APP_NAME,
      currentYear: new Date().getFullYear(),
